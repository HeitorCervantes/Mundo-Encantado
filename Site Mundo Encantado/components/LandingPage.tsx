...
const beneficios = [
  {
    ...
    desc: "Layout moderno, responsivo e pensado para converter.",
  },
  {
    title: "Velocidade e SEO",
    desc: "Carregamento rápido e estrutura amigável a buscadores.",
  },
  {
    title: "Foco em Conversão",
    desc: "CTA destacado, prova social e seções estratégicas.",
  },
];
...
const depoimentos = [
  {
    ...
    cargo: "Empreendedora",
    texto:
      "A landing elevou nossas conversões em poucas semanas. O visual e a narrativa ficaram impecáveis.",
  },
  {
    nome: "Cliente B",
    cargo: "Diretor de Operações",
    texto:
      "Processo simples, rápido e com resultado acima do esperado. Recomendo!",
  },
];
...
const faqs = [
  {
    ...
    a: "Após receber o modelo e os conteúdos, a primeira versão sai rapidamente. Ajustes finos são feitos em ciclos curtos.",
  },
  {
    q: "Vocês também hospedam a página?",
    a: "Posso te orientar a publicar no seu domínio (Vercel/Netlify/Cloudflare Pages).",
  },
  {
    q: "Posso integrar com WhatsApp/Meta Ads/Pixel?",
    a: "Sim. Configuro botões diretos, eventos básicos e pixels ao publicar.",
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 md:py-28 grid md:grid-cols-2 items-center gap-10">
          <motion.div initial={{opacity:0, y:12}} animate={{opacity:1, y:0}} transition={{duration:0.6}}>
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              <a href="#contato" className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-white text-slate-900 font-medium">
                Quero minha página <ArrowRight size={18}/>
              </a>
              <a href="#beneficios" className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-white/10 border border-white/10 font-medium">
                Ver benefícios
              </a>
            </div>
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-6">
          {beneficios.map((b) => (
            <div key={b.title} className="rounded-2xl p-6 bg-white/5 border border-white/10">
              <div className="h-10 w-10 rounded-full bg-white/10 grid place-items-center mb-4">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-indigo-600/20 to-fuchsia-600/20 p-8 md:p-12">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            <a href="#contato" className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-white text-slate-900 font-medium">
              Solicitar proposta <ArrowRight size={18}/>
            </a>
            <a href="#faq" className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-white/10 border border-white/10 font-medium">
              Dúvidas frequentes
            </a>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-6 space-y-2 text-white/80">
              <a href="mailto:contato@suaempresa.com" className="flex items-center gap-2 hover:underline">
                <Mail size={18}/> contato@suaempresa.com
              </a>
              <a href="https://wa.me/5500000000000" className="flex items-center gap-2 hover:underline">
                <Phone size={18}/> (00) 00000-0000
              </a>
              <a href="https://instagram.com/suaempresa" className="flex items-center gap-2 hover:underline">
                <Instagram size={18}/> @suaempresa
              </a>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="rounded-2xl p-6 bg-white/5 border border-white/10">
            <div className="grid gap-4">
              <div>
                ...
                <input required className="mt-1 w-full rounded-xl bg-white/10 border border-white/10 px-3 py-2 outline-none" placeholder="Seu nome" />
              </div>
              <div>
                <label className="text-sm text-white/80">E-mail</label>
                <input type="email" required className="mt-1 w-full rounded-xl bg-white/10 border border-white/10 px-3 py-2 outline-none" placeholder="voce@email.com" />
              </div>
              <div>
                <label className="text-sm text-white/80">Mensagem</label>
                <textarea required rows={4} className="mt-1 w-full rounded-xl bg-white/10 border border-white/10 px-3 py-2 outline-none" placeholder="Fale um pouco sobre seu projeto"/>
              </div>
              <button disabled={sending} className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-white text-slate-900 font-medium disabled:opacity-60">
